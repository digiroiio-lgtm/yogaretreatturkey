...
export const metadata: Metadata = {
  title: "About",
  description: "Learn why Yoga Retreats Turkey is building a curated, AI-enabled wellness marketplace starting with Turkey."
};

export default function AboutPage() {
  return (
    <div className="mx-auto w-full max-w-4xl px-4 py-12 md:px-6">
      <p className="text-xs uppercase tracking-[0.22em] text-stone-500">About Yoga Retreats Turkey</p>
      ...
      <div className="mt-7 space-y-6 text-stone-700">
        <p>
          We built Yoga Retreats Turkey to replace overwhelming listing directories with an elegant, high-trust marketplace for wellness travel. Every retreat is curated for quality, emotional clarity, and practical confidence.
        </p>
        <p>
